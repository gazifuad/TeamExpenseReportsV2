...
# Given a list of file names, perform OCR and then save the result as a 
# csv file in our data folder.
def make_csvs(file_names):
...
make_csvs(file_names)

# These are the documentIDs of receipt images that do NOT have a
# matching OCR file provided, but are also not in Users.csv
without_ocr = ['00d0472591457', '00d0991234867', '00d0413686396', '00d0530594360', '00d0840498429', '00d0343123955', '00d0802473715', '00d0745818528', '00d0403823907', '00d0992302099', '00d0811301203', '00d0741384754', '00d0405749415']
file_names = ["data/img/" + docID + ".jpg" for docID in without_ocr]
make_csvs(file_names)